...
const Header = () => {
  ...
  return (
    <header className="bg-gradient-to-r from-orange-500 via-red-500 to-orange-600 shadow-lg border-b border-orange-400/30 fixed top-0 left-0 right-0 z-40">
      <div className="px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-4">
            {user ? (
              <div className="relative">
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-white/30 backdrop-blur border border-white/40 flex items-center justify-center text-white font-semibold text-sm">
              ...
              <Link
                to="/login"
                className="bg-white/20 backdrop-blur border border-white/30 text-white px-4 py-2 rounded-lg hover:bg-white/30 transition font-medium text-sm"
              >
                Đăng nhập
              </Link>
            )}
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden bg-white/10 backdrop-blur border-t border-white/20 py-4 space-y-2">
            <MobileNavLink
              to="/"
              icon={Home}
              label="Trang chủ"
